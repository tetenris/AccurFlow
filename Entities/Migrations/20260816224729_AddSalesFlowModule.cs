...
{
    /// <inheritdoc />
    public partial class AddSalesFlowModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesQuotations", x => x.SalesQuotationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "SalesQuotationId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesQuotationLineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SalesQuotationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesQuotationLines", x => x.SalesQuotationLineId);
                    table.ForeignKey(
                        name: "FK_SalesQuotationLines_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeliveryOrderLineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DeliveryOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SalesOrderLineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryOrderLines", x => x.DeliveryOrderLineId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryOrders_Status_IsDeleted",
                table: "DeliveryOrders",
