        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockTransferNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransfers_Status_IsDeleted",
                table: "StockTransfers",
                columns: new[] { "Status", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_StockTransfers_StockTransferNumber",
                table: "StockTransfers",
                column: "StockTransferNumber",
                unique: true);
