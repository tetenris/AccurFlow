...
namespace AccuFlow.Application.Features.Approvals.Handlers
{
    public class ApproveApprovalCommandHandler : IRequestHandler<ApproveApprovalCommand>
    {
        ...
        public Task Handle(ApproveApprovalCommand request, CancellationToken cancellationToken)
            => ChangeStatus(request.Request, request.UserId, "Approved", cancellationToken);
