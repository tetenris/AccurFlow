...
- [-] 2. Create view models and request/response DTOs
  ...
  - [ ] 2.2 Create `JournalLineViewModel` for displaying journal lines
    - Include account code and name from related account
    - _Requirements: 7.2_

  
  - [ ] 2.3 Create `JournalEntryDetailViewModel` combining header and lines
    - Include list of JournalLineViewModel

    - _Requirements: 7.1, 7.2, 7.3, 7.4, 7.5_
  
  - [ ] 2.4 Create `CreateJournalEntryRequest` with validation
  ...
  - [ ] 2.6 Create `JournalLineRequest` for line data
  ...
  - [ ] 2.8 Create `PostJournalRequest` and `ReverseJournalRequest`
...
- [x] 3. Implement JournalEntryService with core business logic
  ...
  - [ ] 3.4 Implement Reverse operation
...
- [x] 5. Create JournalEntryController with API endpoints
  ...
  - [ ] 5.3 Implement Datatable endpoint
  ...
  - [ ] 5.8 Implement Post endpoint
    - POST endpoint to finalize journal
    - _Requirements: 4.1-4.6_

  
  - [ ] 5.9 Implement Reverse endpoint
    - POST endpoint to reverse posted journal

    - _Requirements: 5.1-5.6_
  
  - [ ] 5.10 Implement GenerateNumber endpoint
    - GET endpoint to generate next journal number
    - _Requirements: 11.1-11.4_
  
  - [ ] 5.11 Implement GetAccountDropdown endpoint
...
- [x] 7. Create JavaScript file (wwwroot/custom/features/journalentry/index.js)
  ...
  - [ ] 7.7 Implement Reverse functionality
  ...
  - [ ] 7.8 Implement Detail modal functionality
...
- [ ] 9. Test the complete Journal Entry feature

  - [ ] 9.1 Test journal creation
    - Create journal with multiple lines
    - Test balance validation
    - Test account validation
    - _Requirements: 1.1-1.7, 8.1-8.7_
  
  - [ ] 9.2 Test journal editing
    - Edit draft journal
    - Add/remove lines
    - Test status validation (cannot edit posted)
    - _Requirements: 2.1-2.4_
  
  - [ ] 9.3 Test journal posting
    - Post valid journal
    - Verify status change
    - Verify cannot edit after posting
    - _Requirements: 4.1-4.6_
  
  - [ ] 9.4 Test journal reversal
